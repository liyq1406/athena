...
public class ShiroFilterFactoryBean{
	...
	private static transient final Logger logger = LoggerFactory.getLogger(ShiroFilterFactoryBean.class);

	private SecurityManager securityManager;
	
	private ResourceManager resourceManager;//URL资源管理类
...
//	public Class<ToftShiroFilter> getComponentType() {
//		return ToftShiroFilter.class;
//	}
    ...
    protected FilterChainManager createFilterChainManager(FilterConfig filterConfig) {
        ...
        manager.setFilterConfig(filterConfig);
...
//        Map<String, Filter> sfilters = this.filters;
        ...
        if(resourceManager!=null){
        	for (Map.Entry<String, String> entry : resourceManager.getFilterChainDefinitionMap().entrySet()) {
                String url = entry.getKey();
                String chainDefinition = entry.getValue();
                manager.createChain(url, chainDefinition);
            }
        }
        logger.info("createFilterChainManager success!");
        return manager;
    }
...
//        String unauthorizedUrl = this.unauthorizedUrl;
...
//	private static final class ToftShiroFilter extends AbstractShiroFilter {
//	
//	    protected ToftShiroFilter(WebSecurityManager webSecurityManager, FilterChainResolver resolver) {
//	        super();
