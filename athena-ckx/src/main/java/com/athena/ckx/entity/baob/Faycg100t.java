...
public class Faycg100t extends PageableSupport implements Domain {
	...
	public String getHuizsj() {
		return huizsj;
	}

	public void setHuizsj(String huizsj) {
		this.huizsj = huizsj;
	}
	...
	public BigDecimal getUsgl() {
		return usgl;
	}

	public void setUsgl(BigDecimal usgl) {
		this.usgl = usgl;
	}
