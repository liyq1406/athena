...
public class FahtzcxAction extends ActionSupport{
	@Inject
	private FahtzcxService fahtzcxService;
	 ...
	 * @return String
	 */
	public String query(@Param Fahtzcx bean){
		try {
			...
			setResult("result", fahtzcxService.query(bean,getParam("exportXls")));
