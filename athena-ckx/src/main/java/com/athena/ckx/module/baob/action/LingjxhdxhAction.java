...
public class LingjxhdxhAction extends ActionSupport{
	@Inject
	 ...
	 * @return String
	 */
	public String query(@Param Lingjxhdxh bean){
		try {
			setResult("result", lingjxhdxhService.query(bean,getParam("exportXls")));
