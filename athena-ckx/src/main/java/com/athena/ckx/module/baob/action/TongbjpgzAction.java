...
import com.athena.ckx.module.baob.service.TongbjpgzService;
...
public class TongbjpgzAction extends ActionSupport{
	@Inject
	private TongbjpgzService tongbjpgzService;
	/**
	 * 用户级操作日志
	 * @author denggq
	 * @date 2012-5-9
	 ...
	 * @return String
	 */
	public String query(@Param Tongbjpgz bean){
		try {
			setResult("result", tongbjpgzService.query(bean,getParam("exportXls")));
