 ...
 * @date 2012-5-17
 */
public class BaseSheetHandler extends SheetHandler {
	protected static Logger logger = Logger.getLogger(BaseSheetHandler.class);	//定义日志方法
	private static Properties prop;
	private String editor;
	private AbstractIBatisDao baseDao;
	public BaseSheetHandler(Workbook workbook, String sheet, String table,
