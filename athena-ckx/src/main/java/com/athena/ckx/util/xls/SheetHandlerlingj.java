 ...
 * @date 2012-5-17
 */
public abstract class SheetHandlerlingj {
	...
	public SheetHandlerlingj(Workbook workbook, String sheet, String table,
	 ...
	 * @param dateFormats
	 */
	public SheetHandlerlingj(Document document, String sheet, String table,
			String datasourceId, String clazz,String keys,String dateColumns,String dateFormats) {
		super();
	...
	public abstract String doSheetHandler(Map<String, Object> mapusercenter,String editor,Map<String,String> map,AbstractIBatisDao baseDao,String usercenter);
