 ...
 * @date 2012-5-17
 */
public abstract class SheetHandlerlingjck {
	...
	public SheetHandlerlingjck(Workbook workbook, String sheet, String table,
	 ...
	 * @param dateFormats
	 */
	public SheetHandlerlingjck(Document document, String sheet, String table,
			String datasourceId, String clazz,String keys,String dateColumns,String dateFormats) {
		super();
	...
	public abstract String doSheetHandler(String editor,Map<String, String>  maplingj,Map<String,String>  mapcangk,Map<String, String>  mapzick,Map<String, String>  mapbaoz,Map<String, String> mapxiehzt,AbstractIBatisDao baseDao);
