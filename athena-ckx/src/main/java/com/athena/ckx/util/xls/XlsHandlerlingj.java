...
public class XlsHandlerlingj {
	...
	public Map<String, Object> getMapusercenter() {
		return mapusercenter;
	}

	public void setMapusercenter(Map<String, Object> mapusercenter) {
	...
	private XlsHandlerlingj() {
		super();
	}

	public static XlsHandlerlingj getInstance(Map<String, Object> mapusercenter,Map<String, String>  map,InputStream in,String jsonConfig,String editor,AbstractIBatisDao baseDao,String usercenter){
		XlsHandlerlingj handler = new XlsHandlerlingj();
		handler.setIn(in);
		...
		handler.setUsercenter(usercenter);
		return handler;
	}
	...
	public String doXlsHandler(){
		...
		try {
			...
			for(int i=0;i<jsonArry.size();i++){
				...
				String error = SheetHandlerFactorylingj.getInstance(document,sheet,table,datasourceId,clazz,keys,dateColumns,dateFormats).doSheetHandler(mapusercenter,editor,map,baseDao,usercenter);
				//填充错误信息
