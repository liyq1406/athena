 ...
 * @date 2016-11-3
 */
public class XlsHandlerquhyunsjinjj {
	...
	private XlsHandlerquhyunsjinjj() {
		super();
	}

	public static XlsHandlerquhyunsjinjj getInstance(InputStream in,String jsonConfig,String editor,Map<String,String> map,AbstractIBatisDao baseDao){
		XlsHandlerquhyunsjinjj handler = new XlsHandlerquhyunsjinjj();
		handler.setIn(in);
	...
	public String doXlsHandler(){
		...
		try {
			...
			for(int i=0;i<jsonArry.size();i++){
				...
				String error = SheetHandlerFactoryquhyunsjinjj.getInstance(document,sheet,table,datasourceId,clazz,keys,dateColumns,dateFormats).doSheetHandler(editor,map,baseDao);
				//填充错误信息
