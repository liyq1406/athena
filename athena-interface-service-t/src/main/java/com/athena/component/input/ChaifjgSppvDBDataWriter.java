 ...
 *
 */
public class ChaifjgSppvDBDataWriter extends DbDataWriter{
	...
	public boolean before() {
		try{
			String sqlStr =" delete from "+SpaceFinal.spacename_xqjs+".xqjs_anxmaoxq t " 
			  +" where t.xhsj < (select t1.lastcpltime  from in_zidb t1 where t1.inbh = '1150' ) "
			  +" and t.laiybs = '2'";
