...
public class ChexptDataWriter extends DbDataWriter{
	
	protected static Logger logger = Logger.getLogger(ChexptDataWriter.class);	//定义日志方法
	
	private Date date= new Date();
	
	public ChexptDataWriter(DataParserConfig dataParserConfig) {
