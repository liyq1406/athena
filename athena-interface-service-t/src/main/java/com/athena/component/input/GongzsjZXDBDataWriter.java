...
public class GongzsjZXDBDataWriter extends DbDataWriter {
	protected static Logger logger = Logger.getLogger(GongzsjZXDBDataWriter.class);	//定义日志方法
	
	
	public GongzsjZXDBDataWriter(DataParserConfig dataParserConfig) {
		super(dataParserConfig);
	}
	public boolean before() {
		try{
			logger.info(new Date()+"开始执行输入......");
			String sql="truncate table "+SpaceFinal.spacename_ck+".CKX_GONGZSJMB";
			super.execute(sql);
			super.commit();
		}
