 ...
 */
public class GundmxqDbDataWriter extends DbDataWriter {
	...
	public void insertMaoxq(String xuqbc,String xuqcfsj,String xuqly){
		...
		sqlBuf.append(xuqly).append("','0','1050',to_date('").append(DateTimeUtil.getAllCurrTime());
		sqlBuf.append("','yyyy-MM-dd HH24:mi:ss'),'1050',to_date('").append(DateTimeUtil.getAllCurrTime()).append("','yyyy-MM-dd HH24:mi:ss'),'1')");
		super.execute(sqlBuf.toString());
	}
	...
	public void saveYicbj(String cuowxxxx,String lingjbh,String usercenter){
		...
		sqlBuf.append(usercenter).append("','200','").append(cuowxxxx).append("','1050','1050','1050',to_timestamp('");
		sqlBuf.append(DateTimeUtil.getAllCurrTime()).append("','yyyy-MM-dd HH24:mi:ss'),'1050',to_timestamp('");
