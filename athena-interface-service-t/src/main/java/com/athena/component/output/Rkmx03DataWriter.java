...
/**
 * 处理仓库明细表 操作码为O3的结果集输出
 * @author chenlei
 * @vesion 1.0
 * @date 2012-4-19
 */
public class Rkmx03DataWriter extends TxtDataWriter {
	protected static Logger logger = Logger.getLogger(Rkmx03DataWriter.class);	//定义日志方法

	public Rkmx03DataWriter(DataParserConfig dataParserConfig) {
	...
	public void fileAfter(OutputStreamWriter out) {
		...
		dataEchange.doExchange("CKMX_08",out,getTotal(),dataParserConfig.getWriterConfigs()[0].getUsercenter());
	}
}
