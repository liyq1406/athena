...
public class Xitcsdy extends PageableSupport implements Domain{
	...
	private String qujzdz;		//区间MAX值
	
	private String qujzxz;		//区间MIN值
	
	private String paix;		//排序
	...
	public String getQujzdz() {
		return qujzdz;
	}

	public void setQujzdz(String qujzdz) {
		this.qujzdz = qujzdz;
	}

	public String getQujzxz() {
		return qujzxz;
	}

	public void setQujzxz(String qujzxz) {
		this.qujzxz = qujzxz;
	}
