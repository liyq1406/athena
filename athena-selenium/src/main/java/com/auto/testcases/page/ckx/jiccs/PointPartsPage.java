...
public class PointPartsPage extends Page{
	public PointPartsPage() {
		this.comment = "消耗点-零件";
		this.init();
	}
	...
	
	{
		...
		text_conditionMark.addXpathLocator("//div[@id='lingjxhd_biaos']/table/tbody/tr/td/input");
		opti_conditionMark.addXpathLocator("//div[@id='field-pop-lingjxhd_biaos']/div[2]");
		opti_conditionMark2.addXpathLocator("//div[@id='field-pop-lingjxhd_biaos']/div[3]");
		
		text_mark.addXpathLocator("//div[@id='grid_lingjxhd']/div[6]/table/tbody/tr/td[2]/div/table/tbody/tr[2]/td[13]");
