...
public class SuppliersPage extends Page{
	...
	
	{
		...
		butt_submit.addXpathLocator("//form[@id='form_neibgys']/div[2]/table/tbody/tr/td/div/div/div/a");
		text_mark.addXpathLocator("//div[@id='gongys_biaos']/table/tbody/tr/td/input");
		opti_mark.addXpathLocator("//div[@id='field-pop-gongys_biaos']/div[2]");
		opti_mark2.addXpathLocator("//div[@id='field-pop-gongys_biaos']/div[3]");
		list_parts.addXpathLocator("//div[@id='grid_gongys']/div[6]/table/tbody/tr/td[2]/div/table/tbody/tr");
	}
