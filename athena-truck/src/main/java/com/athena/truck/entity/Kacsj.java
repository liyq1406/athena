 ...
 *
 */
public class Kacsj extends PageableSupport implements Domain{

	private static final long serialVersionUID = 3196732868065228459L;
	
	private String kach;		//卡车号
	private String shoujh;		//手机号
	private String sijxm;		//司机姓名
	...
	private String oldsjh;	//老手机号
	
	public String getOldsjh() {
		return oldsjh;
	}
	public void setOldsjh(String oldsjh) {
		this.oldsjh = oldsjh;
	}
	...
	public void setShoujh(String shoujh) {
		this.shoujh = shoujh;
	}
	public String getSijxm() {
		return sijxm;
	}
	public void setSijxm(String sijxm) {
		this.sijxm = sijxm;
	}
