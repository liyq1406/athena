 ...
 * 2011-12-01
 */
public class MaoxqhzjcTmp extends PageableSupport{
	...
	private String gcbh;
	private String shengcxbh; //生产车间号
	...
	//xss-20161125_ 0012989
	private BigDecimal kuc_new;//最新库存盈余	
	
	
	
	public BigDecimal getKuc_new() {
		return kuc_new;
	}
	public void setKuc_new(BigDecimal kuc_new) {
		this.kuc_new = kuc_new;
	}
	public int getJidgs() {
		return jidgs;
	}
	public void setJidgs(int jidgs) {
		this.jidgs = jidgs;
	}
	public int getPianysj() {
		return pianysj;
	}
	public void setPianysj(int pianysj) {
