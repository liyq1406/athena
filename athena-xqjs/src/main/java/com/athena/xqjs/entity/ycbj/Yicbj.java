package com.athena.xqjs.entity.ycbj;
...
public class Yicbj extends PageableSupport{
	 ...
	 * @param editor
	 */
	public Yicbj(String usercenter, String lingjbh, String cuowlx,
			String cuowxxxx, String jihyz, String jihydm, String jismk,
			String creator, String create_time, String edit_time, String editor) {
		super();
		this.usercenter = usercenter;
		this.lingjbh = lingjbh;
		this.cuowlx = cuowlx;
