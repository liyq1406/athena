 ...
 */
@Component
public class XinAxParam extends BaseService{
	
	/**
	 * 日志打印
	 */
	public static final Logger logger = Logger.getLogger(XinAxParam.class);
	...
	*/
	 ...
	 * 库存置换MAP
	 */
	public static HashMap<String,Kuczh> kuczhMap;
	...
	public void initParam(Map<String,String> map){
		...
		kuczhMap = new HashMap<String,Kuczh>();	
