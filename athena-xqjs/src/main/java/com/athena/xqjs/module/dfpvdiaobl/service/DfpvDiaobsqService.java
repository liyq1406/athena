 ...
 */
@Component
public class DfpvDiaobsqService extends BaseService {
	// LOG4J日志打印信息
	...
	public Diaobsq selectDiaobsq(Diaobsq bean) {
		...
		return (Diaobsq) baseDao.getSdcDataSource(ConstantDbCode.DATASOURCE_CKX).selectObject("dfpvdiaobl.test_selectDiaobsq", bean);
	}
	...
	public String getdiaosqdh(String usercenter) {
		...
		String diaobsqdh = (String) baseDao.getSdcDataSource(ConstantDbCode.DATASOURCE_CKX).selectObject("dfpvdiaobl.querydiaobsqdh", dh);
		if (null == diaobsqdh) {
			diaobsqdh = dh + "001";
		} else {
	...
	public Diaobsqmx selectLingjmc(Map<String, String> map) {
		Diaobsqmx sqmx = (Diaobsqmx) baseDao.getSdcDataSource(ConstantDbCode.DATASOURCE_CKX).selectObject("dfpvdiaobl.querylingjmc", map);
		if (sqmx == null) {
	...
	public int doInsert(Diaobsq bean) {
		...
		return baseDao.getSdcDataSource(ConstantDbCode.DATASOURCE_XQJS).execute("dfpvdiaobl.insertdiaobsq", bean);
	}
	...
	public int doInsertmx(Diaobsqmx bean) {
		// 序号加1
		Integer xuh = (Integer) baseDao.getSdcDataSource(ConstantDbCode.DATASOURCE_CKX).selectObject("dfpvdiaobl.select_sqxuh", bean);
		// 序号为空，初始为零
		int xuH = xuh == null ? 0 : xuh;
		bean.setXuh(xuH + 1);
		return baseDao.getSdcDataSource(ConstantDbCode.DATASOURCE_XQJS).execute("dfpvdiaobl.insertdiaobsqmx", bean);
	}
	...
	public String dbsqprint(List<Diaobsq> sqlist) {
		...
		for (Diaobsq diaobsq : sqlist) {
			...
			dfpvdiaobsqOperationService.updateBanc(bean);
			// 时间格式yyyy-mm-dd
			...
			ArrayList<Diaobsqmx> sqmxls = (ArrayList<Diaobsqmx>) baseDao.getSdcDataSource(ConstantDbCode.DATASOURCE_CKX).select("dfpvdiaobl.select_Diaobsqmx", map);
...
//				        Integer num =  (Integer) baseDao.getSdcDataSource(ConstantDbCode.DATASOURCE_CKX).selectObject("dfpvdiaobl.querylucz", map);
//						if(num == 0){
...
//						}
	...
	public List<Lingj> queryList(Map<String, String> paramMap)
	{
		...
		return baseDao.getSdcDataSource(ConstantDbCode.DATASOURCE_CKX).select("dfpvdiaobl.queryLingj", paramMap);
	}
	public List<Lingj> queryListZh(Map<String, String> paramMap)
	{
		return baseDao.getSdcDataSource(ConstantDbCode.DATASOURCE_CKX).select("dfpvdiaobl.queryDinghlxzhs", paramMap);
	}
	
	private List<String> queryDinglx() {
		return baseDao.getSdcDataSource(ConstantDbCode.DATASOURCE_CKX).select("dfpvdiaobl.queryDinghlxs");
	}
...
//	}
	 ...
	 * 查询dfpv最新的库存数量
	 * */
	public  com.athena.xqjs.entity.diaobl.Diaobmx queryKcsl(Diaobsqmx mxBean) {
		...
		mxBean.setZiyhqrq(kcmap.get("ZIYHQRQ") == null ? "" : kcmap.get("ZIYHQRQ"));
		
		return (com.athena.xqjs.entity.diaobl.Diaobmx)baseDao.getSdcDataSource(ConstantDbCode.DATASOURCE_CKX).selectObject("dfpvdiaobl.queryDiaobshmx_notexist", mxBean);
