...
@WebService(endpointInterface="com.athena.xqjs.module.hlorder.service.VJCalculate", serviceName="/vjCalculate")
@Component
public class VJCalculateService  extends BaseService implements VJCalculate{
	@Inject
	...
	public  final Logger log = Logger.getLogger(VJCalculateService.class);
	public void vjCalculateUl(){
		vjCalculate("4311", "UL",Const.VJJS_UL);
	}
	
	public void vjCalculateUw(){
		vjCalculate("4312", "UW",Const.VJJS_UW);
	}
	
	public void vjCalculateUx(){
		vjCalculate("4313", "UX",Const.VJJS_UX);
	}
	
	public void vjCalculateVd(){
		vjCalculate("4314", "VD",Const.VJJS_VD);
	}
	
	private String vjCalculate(String jkCode ,String userCenter,String jssdm) throws RuntimeException{
				...
				if(StringUtils.isNotBlank(ziyxqrq))
				{
					...
					//加用户中心，获取毛需求列表
					 ...
					 if( null != al && al.size() > 0)
					 {
						 ...
						 {
							 message = this.vjOrderService.doCalculate("97W", "VJ", ziyxqrq, "", flagBanc, userCenter,loginUser,null,jkCode);
						 }
					 }
