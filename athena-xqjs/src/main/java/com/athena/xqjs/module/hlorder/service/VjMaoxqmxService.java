...
@Component
public class VjMaoxqmxService extends BaseService {
	@Inject
	...
	public String getParrten(String nameSpace, String parrten) {
		Map<String, String> map = new HashMap<String, String>();
		map.put(Const.VJ, nameSpace + "insertMaoxqhzjTmp");
    ...
    //xss 20161011 v4_015
    //查找没有最新毛需求版次的零件编号
    public List<Wullj> getWulljLingj(String user,String banc,String zhizlx){
    	Map<String, Object> inMap = new HashMap<String, Object>();
		inMap.put("usercenter", user);
		inMap.put("zhizlx", zhizlx);
		inMap.put("xuqbc", banc);
		List<Wullj> list = this.baseDao.getSdcDataSource(ConstantDbCode.DATASOURCE_CKX).select("ilorder.getWulljLingj", inMap);
		return list;
    }
