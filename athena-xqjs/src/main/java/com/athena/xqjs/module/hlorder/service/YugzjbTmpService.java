 ...
 */
@Component
public class YugzjbTmpService extends BaseService {
	/**
	 * @插入操作
	 * @author 李明
	 * @version v1.0
	...
	public String doInsert(YugzjbTmp bean) {
	 ...
	 /**
		 ...
		 * @date 2012-01-03
		 */
	public void doAllDelete(String usercenter) {
		Map<String,String>map = new HashMap<String,String>();
		map.put("usercenter", usercenter);
	    baseDao.getSdcDataSource(ConstantDbCode.DATASOURCE_XQJS).execute("hlorder.deleteYugzjbTmp",map);
	}
