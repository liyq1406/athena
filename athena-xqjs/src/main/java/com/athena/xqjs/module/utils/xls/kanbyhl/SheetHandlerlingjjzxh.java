 ...
 * @date 2012-5-17
 */
public abstract class SheetHandlerlingjjzxh {
	...
	public SheetHandlerlingjjzxh(Workbook workbook, String sheet, String table,
	 ...
	 * @param dateFormats
	 */
	public SheetHandlerlingjjzxh(Document document, String sheet, String table,
			String datasourceId, String clazz,String keys,String dateColumns,String dateFormats) {
		super();
	 ...
	 */
	public abstract String doSheetHandler(String editor,Map<String,List<Kanbxhgm>> map,AbstractIBatisDao baseDao) throws BiffException, IOException, ParseException;
