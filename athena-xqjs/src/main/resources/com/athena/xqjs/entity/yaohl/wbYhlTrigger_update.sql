create or replace trigger XQJS_WBYHL_UPDATE
  after update on ck_yaohl 
  for each row 
declare
...
begin
  if :new.yaohlzt=yhlzt_yjf and :old.yaohlzt!=yhlzt_yjf then 
         --更新订单明细
     ...
     -- 要货令状态 为 已终止       
     elsif :new.yaohlzt=yhlzt_yzz and :old.yaohlzt!=yhlzt_yzz then
           update xqjs_dingdmx ddmx 
